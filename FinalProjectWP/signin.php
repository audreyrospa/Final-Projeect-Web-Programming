			...
			<div class="col-5 transparent3 p-5">
				...
				<form method="post" action="signinprocess.php">
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control bg-transparent text-white rounded-0" name="nim" id="exampleInputEmail1" placeholder="Nim">
				  </div>
				  <div class="form-group">
				  ...
				  <p class="center">don't have an account? <a href="signup.php" id="link">Sign up</a></p>
				  <p class="center">sign in as admin <a href="admin_signin.php" id="link">Sign in</a></p>
				</form>
			</div>
		</div>
	</main>
