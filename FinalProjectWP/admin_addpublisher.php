	...
	<main class="container-fluid p-5">
		<div class="row justify-content-md-center">
			<div class="col-7 transparent3 p-5">
				<h1 class="text-center mb-4">Add New Publisher</h1>
				<form method="post" action="admin_addpublisherprocess.php">
				  <div class="form-group">
				    <label for="exampleInputEmail1">Publisher Id</label>
				    <input type="text" class="form-control bg-transparent text-white rounded-0" name="pubid" placeholder="Publisher Id" required>
				  </div>
				  <div class="form-group">
				    <label for="exampleInputEmail1">Publisher Name</label>
				    <input type="text" class="form-control bg-transparent text-white rounded-0" name="pubname" placeholder="Publisher Name" required>
				  </div>
				  <div class="form-group">
				    <label for="exampleInputEmail1">Address</label>
				    <input type="text" class="form-control bg-transparent text-white rounded-0" name="pubadd" placeholder="Address" required>
				  </div>
				  <div class="form-group">
				    <label for="exampleInputEmail1">Contact Number</label>
				    <input type="text" class="form-control bg-transparent text-white rounded-0" name="pubcon" placeholder="Contact Number" required>
				  </div>
